...
Your task is to help the user find specific information on this website. Here's what you know about the site structure:
...
2. Look for search functionality if available
